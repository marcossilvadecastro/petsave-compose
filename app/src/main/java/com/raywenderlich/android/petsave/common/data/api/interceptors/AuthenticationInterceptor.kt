...
import com.raywenderlich.android.petsave.common.data.api.ApiConfiguration.AUTH_ENDPOINT
...
class AuthenticationInterceptor @Inject constructor(
    ...
    private fun Interceptor.Chain.refreshToken(): Response {
        ...
        val body = FormBody.Builder()
            ...
            .add(CLIENT_ID, ApiConfiguration.KEY)
            .add(CLIENT_SECRET, ApiConfiguration.SECRET)
            .build()
